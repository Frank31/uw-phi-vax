## Prep Province Vaccination Data
# Author: Francisco Rios, modified by Frances Gellert
# Purpose: This script will create complete Province dataset for past few years
# Date: Aug 02 2023
