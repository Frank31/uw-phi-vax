# 03_prep_healthcare_worker_covid_data.R
...
saveRDS(extracted_estimates, file = paste0(data_folder, "prepped_data/cms_healthcare_worker/_merged_nursing_home_data", date, ".RDS"))
