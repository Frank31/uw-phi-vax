...
# load the DALY data
daly_data <- readRDS(paste0(prepped_data_dir, "aim_3/01_prepped_dalys_under4.RDS"))
...
full_data <- full_data %>% 
  select(location, region, year, gbd_location_id, iso_code, iso_num_code, sdi,
...
saveRDS(full_data, file=paste0(prepped_data_dir, "aim_3/02_prepped_full_data_18Jan2023.RDS"))
