...
ny_data <- ny_data %>% filter(region %in% c("Kings", "Queens", "New York", "Suffok", "Bronx", "Nassau"))
...
write.csv(final_output_table, file=paste0("C:/Users/frc2/UW/og_merck_hpv_vaccine_hesitancy - Documents/General/Results/08_county_results.csv"))
